...
namespace Akqa.Global
{
    public static class AmountInWords
    {
        public static string ConvertToWords(decimal value)
        {
            ...
            string strWords = GetWordsForNumber(input) + " Dollars";


            if (decimals.Length > 0)
            {
                // if there is any decimal part convert it to words and add it to strWords.
                strWords += " and " + GetWordsForNumber(decimals) + " Cents";
            }

            return strWords;
        }

        private static string GetWordsForNumber(string input)
        {
            ...
            while (input.Length > 0)
            {
                ...
                _3digits = ConvertNumberToWord(no);
        ...
        private static string ConvertNumberToWord(int no)
        {
            string[] Ones =
            {
